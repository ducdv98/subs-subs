...
function parseClampedNumber(value, fallback, range) {
...
export function parseSettings(raw) {
    ...
    return {
        ...
        secondaryLineColor: typeof candidate.secondaryLineColor === "string" &&
            HEX_COLOR_RE.test(candidate.secondaryLineColor)
            ? candidate.secondaryLineColor
            : DEFAULT_SETTINGS.secondaryLineColor,
        secondaryLineSize: parseClampedNumber(candidate.secondaryLineSize, DEFAULT_SETTINGS.secondaryLineSize, SECONDARY_LINE_SIZE_RANGE),
        secondaryLinePosition: parseClampedNumber(candidate.secondaryLinePosition, DEFAULT_SETTINGS.secondaryLinePosition, SECONDARY_LINE_POSITION_RANGE),
        secondaryLineOpacity: parseClampedNumber(candidate.secondaryLineOpacity, DEFAULT_SETTINGS.secondaryLineOpacity, SECONDARY_LINE_OPACITY_RANGE),
    };
}
